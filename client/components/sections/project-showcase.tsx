  ...
  return (
    <section className="container mx-auto px-4">
      <div className="flex flex-col items-center justify-between gap-4 md:flex-row md:items-end">
        ...
        {/* --- THE FIX --- */}
        {/* Changed 'href' to 'to' and 'bg-secondary/50' to 'bg-secondary' */}
        <Link 
          to="/projects" 
          className="inline-flex items-center justify-center rounded-full border border-border bg-secondary px-8 py-3 text-sm font-semibold uppercase tracking-[0.28em] text-foreground shadow-soft transition-transform duration-200 hover:-translate-y-0.5"
        >
          View All Projects
        </Link>
      </div>
